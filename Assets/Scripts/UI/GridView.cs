...
public class GridView : MonoBehaviour
{
    ...
    [SerializeField] private Button Room2x2Button;
    ...
    private void Awake()
    {
        ...
        Room2x2Button.onClick.AddListener(() => OnRoom2x2Selected());
    }
    ...
    private void OnRoom2x2Selected()
    {
        OnRoomSelected?.Invoke(Rooms[2]);
    }
}
